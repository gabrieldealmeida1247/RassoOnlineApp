...
class HistoryServiceWorkerAdapter(private val context: Context, private val manageServiceHistory: List<ManageServiceHistory>) : RecyclerView.Adapter<HistoryServiceWorkerAdapter.ManageServiceHistoryViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ManageServiceHistoryViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.history_service_worker_item_layout, parent, false)
