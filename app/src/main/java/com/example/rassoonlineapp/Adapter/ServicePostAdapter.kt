...
class ServicePostAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.services_post_item_layout, parent, false)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var profileImage: CircleImageView = itemView.findViewById(R.id.user_profile_image_post_service)
        var userName: TextView = itemView.findViewById(R.id.user_name_post_service)
        var dateHour: TextView = itemView.findViewById(R.id.data_hora_service)
        var tittle: TextView = itemView.findViewById(R.id.textView_tittle_service)
        var description: TextView = itemView.findViewById(R.id.textView_description_service)
        var skills: TextView = itemView.findViewById(R.id.textView_skills_service)
        var work: TextView = itemView.findViewById(R.id.textView_work_service)
        var orcamento: TextView = itemView.findViewById(R.id.textView_preco_service)
        var prazo: TextView = itemView.findViewById(R.id.textView_prazo_service)
    }
