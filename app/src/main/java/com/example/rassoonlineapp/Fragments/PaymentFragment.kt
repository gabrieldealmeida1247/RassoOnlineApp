...
class PaymentFragment : DialogFragment() {
    ...
    // Função para atualizar o total pago pelo usuário e o último valor pago
    ...
    // Função para atualizar o total pago pelo usuário
                            ...
                            for (childSnapshot in dataSnapshot.children) {
                                ...
                                if (transferData != null) {
                                    ...
                                    childSnapshot.ref.child("amount").setValue(newAmount)
                                        .addOnSuccessListener {
                                            // Atualize o textViewAmount com o novo saldo, se necessário
                                            // Atualize os ganhos do usuário em PaymentStats
    ...
    // Função para atualizar os ganhos do usuário, incluindo o último valor ganho
    ...
    private fun ManageCount(){
        ...
        postRef.get().addOnSuccessListener { dataSnapshot ->
            if (dataSnapshot.exists()) {
                ...
                val service = ServiceCount(concludeCount = 1, cancelCount = 0, postsCount = 0, propCount = 0, proposalsRefuseCount = 0, proposalsAcceptCount = 0, deleteCount = 0)
